...
def results_page():
    ...
    if condition.get("Referral") and st.button("📅 Schedule a Consultation or Get Help"):
        st.markdown("<meta http-equiv="refresh" content="0; url=https://lexconsult.carekonnect.net/">", unsafe_allow_html=True)
        st.link_button("Open LexConsult", "https://lexconsult.carekonnect.net/", use_container_width=True)
