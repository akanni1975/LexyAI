...
WORKBOOK_PATH = os.getenv("SYMPTOMBOT_WORKBOOK", "SymptomBot_Version_11_anchor_gate_tightened.xlsx")
...
def welcome_page():
    ...
    **Go for emergency care now** if you have:
    ...
    if pref not in {"necessary", "optional"}:
        st.warning("This triage service requires necessary cookies to operate effectively")
        return
